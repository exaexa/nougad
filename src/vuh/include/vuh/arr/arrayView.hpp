...
/// Maybe used in place of array references in copy routines and kernel
/// invocations to pass parts of the array data.
...
public:
  ...
  /// @return offset (number of elements) of the beggining of the span wrt to
  /// buffer
...
private:                     // data
  ...
  std::size_t _offset_begin; ///< offset (number of array elements) of the
                             ///< beginning of the span
  std::size_t _offset_end;   ///< offset (number of array elements) of the end
                           ///< (one past the last valid elements) of the span.
}; // class ArrayView

/// Create a ArrayView into given Array.
template<class Array>
auto
array_view(Array &array, std::size_t offset_begin, size_t offset_end)
  -> ArrayView<Array>
{
